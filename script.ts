...
const newCardBtn: Element = document.querySelector("#newcard-btn")!;
const movesEl: Element = document.querySelector("#moves")!;
...
const updateUi = (card: string, sum: number, message: string, moves: number, score: number) => {
